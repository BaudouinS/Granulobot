...
void setup(){
  ...
  Serial.println("Firmware Granulobot UDP V12");
 ...
 if (Motor.State==1){  //if "stiff" selected
      ...
      if (Motor.Plus_State || Motor.Minus_State){  
          ...
          if (test<300){  
             ...
             if (currentMillis2 - previousMillis2 >= 1){   //PID computed value updated every 10ms
...
//                   
          ...
          if (currentMillis4 - previousMillis4 >= 1){   //PID computed value updated every 3ms
