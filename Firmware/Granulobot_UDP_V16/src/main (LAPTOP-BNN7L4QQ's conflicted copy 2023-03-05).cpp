...
////////////////////////////////////////////////////////////
 ...
 if (Motor.State==19){
    ...
    PWM_raw=round((H1*U0)+(H1*signOfX*U)-(G*H2*(float)theta_star)+(H3*A*DEMA_avg)+(Amp*sin((pulsation*(float)time_wave)/1000)));
...
//  //Serial.print(" ");Serial.println(millis());
  ...
  // if (currentMillis16 - previousMillis16 >= 2000){//4){   //1/this value=frequency at which messages are sent outward
